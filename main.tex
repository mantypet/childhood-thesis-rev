...
Mallin satunnaisvaikutusten määrittely vaikuttaa parantavan huomattavasti mallin kykyä selittää yksilöiden välistä vaihtelua, mutta on pidettävä todennäköisenä, että olisi löydettävissä sellaisia painoindeksiin vaikuttavia taustatekijöitä, joiden avulla voisimme parantaa myös kiinteiden vaikutusten selitysvoimaa. Lisäksi mallissa on osoitettavissa selviä puutteita varianssin heteroskedastisuuden ja residuaalien välisen autokorrelaation huomioimisessa.\\
