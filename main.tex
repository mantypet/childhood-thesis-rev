...
\centering
  ...
  \caption{Yksilökohtaiset painoindeksiprofiilit iän mukaan (harmaa). Yksittäisiä painoindeksiprofiileja korostettu mustalla.}
  \label{fig:bmi_age}
\end{figure}
...
\centering
  ...
  \caption{Yksilökohtaiset painoindeksiprofiilit seuranta-ajan mukaan (harmaa). Yksittäisiä painoindeksiprofiileja korostettu mustalla.}
...
\centering
  ...
  \caption{Kiinteiden vaikutusten mallin lähtöaineistolle ennustetut painoindeksin arvot. Yksittäisiä ennusteita korostettu mustalla.}
...
\centering
  ...
  \caption{Satunnaisvaikutusten mallin LSM~\ref{eq:lme2} lähtöaineistolle ennustetut painoindeksin arvot. Yksittäisiä ennusteita korostettu mustalla.}
...
\centering
  \includegraphics[width=.9\linewidth]{kuvaajat/lme3_fitresid.png}
  \caption{Kriittinen malli $\text{LSM}$~\ref{eq:lme2.2}.}
  \label{fig:lme_krit_fitresid}
\end{subfigure}%
\begin{subfigure}[b]{0.5\textwidth}
\centering
  \includegraphics[width=.9\linewidth]{kuvaajat/lme3_full_fitresid.png}
  \caption{Täysi malli $\text{LSM}$~\ref{eq:lme2}.}
  \label{fig:lme_taysi_fitresid}
\end{subfigure}
\begin{subfigure}[b]{0.5\textwidth}
\centering
  \includegraphics[width=.9\linewidth]{kuvaajat/lme3_vc_fitresid.png}
  \caption{Kriittinen malli $\text{LSM}_{\text{VK}}$~\ref{eq:lme2.2}.}
  \label{fig:lme_vk_krit_fitresid}
\end{subfigure}%
\begin{subfigure}[b]{0.5\textwidth}
\centering
  \includegraphics[width=.9\linewidth]{kuvaajat/lme3_full_vc_fitresid.png}
  \caption{Täysi malli $\text{LSM}_{\text{VK}}$~\ref{eq:lme2}.}
