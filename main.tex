...
Mittausten määrien jakaumista (Taulukko ~\ref{table:mittausmaarat}) huomaamme, että suurimman yksittäisen ryhmän muodostavat yksilöt, joilla on vain yksi mittaus. Tämä selittyy hyvin sillä, että viimeksi aineistoon mukaantulleilla henkilöillä ei ole ehtinyt kertyä vielä mittauksia ja toisaalta aineiston keruun alkuajoilta aineistoa kertyi huomattavasti vähemmän. Huomio on tosin syytä pitää mielessä, sillä yleisesti pitkittäisaineiston oletetaan sisältävän yksilöä kohden vähintään kaksi mittausta \cite{west14}.\\
...
Valtaosalla aineiston yksilöistä on 1\textendash9 mittausta, joten pitkittäisaineiston edellytysten täyttymisestä ei vaikuta olevan huolta. Yksilöitä, joilla on yli 30 mittausta on koko ainestossa vain 101 kappaletta. \\

FinLapset-aineistossa on seuraavat muuttujat

MUUTTUJAT

Sukupuolijakauma (Taulukko ~\ref{table:sukupuolijakauma}) vaikuttaa kuvaavaan Suomen väestöä, jossa poikia on hieman enemmän, kuin tyttöjä. Aineistoa on syntymäkohorteittain kertynyt tasaisesti lukuunottamatta varhaisimpia ja tuoreimpia kohortteja (Taulukko ~\ref{table:ikavuosijakauma})\\
...
\bottomrule
\end{tabular}
\caption{FinLapset-aineiston syntymäkohorttijakauma}
\label{table:ikavuosijakauma}
\end{table}
